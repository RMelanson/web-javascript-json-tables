...
var childDisability=[{
		...
		"ret": "specializedChildExpenseBoots"
	}, {
		"function": "getRandomFirstName",
		"args": [{
				"name": "gender",
		...
		"function": "createDisabledChildInfoEvidence",
		"args": [{
				"name": "icCaseID",
				"value": "${icCaseID}"
			}, {
		...
		"function": "createSpecializedChildExpenseEvidence",
		"args": [{
				"name": "icCaseID",
				"value": "${icCaseID}"
			}, {
				...
				"name": "expenseType",
				"value": "${specializedChildExpenseBoots}"
			}, {
				"name": "expenseAmount",
				"value": "350"
			}
		...
		"function": "createMCSSFamilyCountEvidence",
		"args": [{
				"name": "icCaseID",
				"value": "${icCaseID}"
			}, {
...
var MCSSSTEPREST=[{
		"function": "addSIDToGroup",
		"args": [{
				"name": "groupID",
				"value": "PARTICIPANT_MANAGEMENT_BASICS"
			}, {
				"name": "sid",
				"value": "MCSSSTEPREST.execute"
			}
		]
	}
]
